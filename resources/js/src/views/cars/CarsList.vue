            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{$trans('menu.cars_list')}}</li>
                    </ul>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                <h3 class="h4">{{$trans('menu.cars_list')}}</h3>
                            </div>
                            <div class="">
                                <div class="card-body">
                                    ...
                                    <v-table
                                        ...
                                        <tr>
                                            ...
                                            <th class="border-bottom">{{$trans('cars.plate_number')}}</th>
                                            <th class="border-bottom">{{$trans('device.device_id')}}</th>
                                            <th class="border-bottom">{{$trans('cars.company_name')}}</th>
                                            <th class="border-bottom">{{$trans('cars.branch_city')}}</th>
                                            <th class="border-bottom">{{$trans('cars.date_added')}} </th>
                                        ...
                                        <tr v-for="row in displayData" :key="row.id" :id="row.id">
                                            ...
                                            <td style="overflow-y:visible !important">
                                                ...
                                                <div aria-labelledby="action_menu" class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item" href="#"><i class="fa fa-eye" aria-hidden="true"></i>{{$trans('main.view_details')}}</a>
<!--                                                    TODO ADD NEW DEVICE TO VEHICLE-->
                                                    <router-link class="dropdown-item" :to="{name:'car-edit',params:{idCar:row.id}}"><span class="fas fa-pen"></span> {{$trans('main.edit')}}</router-link>

                                                </div>

                                                <a  @click="modalDeleteCar(row.id)">
...
export default {
    data () {
        return {
            ...
            totalPages: 0,
            filters: {
                search: { value: '', keys: ['plate_number','unique_id','company','created_at'] }
            }
        }
    },
    mounted () {
