            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ $trans('menu.geo-regions') }}</li>
                    </ul>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                <h3 class="h4">{{$trans('menu.geo-regions') }}</h3>
                            </div>
                            <div class="">
                                <div class="card-body">
                                    ...
                                    <v-table
                                        ...
                                        <tr>
                                            ...
                                            <th class="border-bottom">{{$trans('regions.id')}} </th>
                                            <th class="border-bottom">{{$trans('regions.name')}}</th>
                                            <th class="border-bottom">{{$trans('regions.description')}}</th>
                                            <th class="border-bottom">{{$trans('regions.calender')}}</th>
                                            <th class="border-bottom">{{$trans('regions.area')}}</th>
