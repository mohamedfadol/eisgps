            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{$trans('users.partners_list')}}</li>
                    </ul>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                <h3 class="h4">{{$trans('users.partners_list')}}</h3>
                            </div>
                            <div class="">
                                <div class="card-body">
                                    ...
                                    <v-table
                                        ...
                                        <tr v-for="row in displayData" :key="row.traccar.id" :id="row.traccar.id">
                                            ...
                                            <td v-if="row.traccar.disabled === false"><span class="font-weight-normal"><span class="fas fa-check-circle text-success mr-2"></span>{{$trans('main.active')}}</span></td>
                                            ...
                                            <td style="overflow-y:visible !important">
                                                <a v-if="row.traccar.id !== connected.id" href="#" id="action_menu" data-toggle="dropdown" class="mr-2 fw-bold"><span
