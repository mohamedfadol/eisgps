...
<!--                    <li class="breadcrumb-item active" aria-current="page">{{$trans('commands.new_cmd')}}</li>-->
<!--                </ol>-->
<!--            </nav>-->
<!--        </div>-->
...
<!--        <div class="row">-->
<!--            <div class="col-12">-->
<!--               <form @submit.prevent="addNewCommand">-->
<!--                   <div class="card card-body bg-white border-light shadow-sm mb-4">-->


<!--                       <h2 class="h5 my- title_user">{{$trans('commands.new_cmd')}}</h2>-->
...
<!--                           <button type="submit" class="btn btn-success">{{$trans('commands.add')}}</button>-->
<!--                       </div>-->
...
export default {
    ...
    methods: {
        addNewCommand(){
            this.isLoad = true;
            axios.post('/command',this.command,{
