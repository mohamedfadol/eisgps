...
return [
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                'oauth/*','*.json','login',
                'devices.*','test','test2','groups.*','commands.*','positions.*','server','drivers.*',
                'facilities.*','wassel.*','server.*','cars.*','simcards','users.delete','sim_cards.*','partners.*',
                'customers.*','users.show','users.action','users.password.reset','users.profile'
     ...
     */
    'logo' => public_path() . '/images/logoapidocs.png',
    //  'logo' => false,
